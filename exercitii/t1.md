...
<br>
> Datele statice trebuie neapărat inițializate în afara clasei. <br>
> Trebuie să adăugăm ÎN AFARA DECLARĂRII CLASEI : `int Person::generator = 0;` <br>
> ATENTIE!! NU ESTE NEVOIE DE KEYWORDUL STATIC DIN NOU! Nu e nevoie si nici nu trebuie sa il punem! <br>
...
> Pentru EXAMEN -> Codul compileaza si afiseaza: `Constructor Person cu codul 1 si varsta 18
...
> Era mai bine asa? Nu. Se copia obiectul p2 degeaba !
> Solutie : schimbam antentul supraincarcarii operatorului + cu `Person operator+(const Person& p) const`
